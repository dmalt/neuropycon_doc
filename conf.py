...
htmlhelp_basename = 'neuropycon_doc'
...
latex_documents = [
  (master_doc, 'neuropycon.tex', u'neuropycon Documentation',
   u'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'neuropycon', u'neuropycon Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'neuropycon', u'neuropycon Documentation',
   author, 'neuropycon', 'One line description of project.',
   'Miscellaneous'),
]
